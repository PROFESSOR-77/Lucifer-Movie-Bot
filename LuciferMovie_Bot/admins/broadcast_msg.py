# (c) [HeartBeat] @PR0FESS0R-77
# (s) @Mo_Tech_YT , @Mo_Tech_Group, @MT_Botz
# Copyright permission under MIT License
# All rights reserved by PR0FESS0R-77
...
from LuciferMovie_Bot.database._utils import send_msg
...
@LuciferMovie_Bot.on_message(filter.private & filter.command(["broadcast", "send"]) & filter.user(ADMINS) & filter.reply)
